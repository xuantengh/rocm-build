...
# wget https://repo.radeon.com/rocm/apt/6.0/pool/main/h/hsa-amd-aqlprofile/hsa-amd-aqlprofile_1.0.0.60000.60000-91~22.04_amd64.deb -O $ROCM_TMP_DIR/hsa-amd-aqlprofile_$ROCM_VERSION.deb
