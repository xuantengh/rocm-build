...
set -e
# ROCt
git clone https://github.com/ROCm/ROCT-Thunk-Interface $ROCM_TMP_DIR/roct \
  -b rocm-$ROCM_VERSION --depth 1
...
# ROCr
git clone https://github.com/ROCm/ROCR-Runtime $ROCM_TMP_DIR/rocr \
  -b rocm-$ROCM_VERSION --depth 1
